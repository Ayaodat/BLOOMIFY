...
namespace Bloomify.Controllers
{
    public class ProductImagesController : Controller
    {
        ...
        {
            ViewData["ProductId"] = new SelectList(_context.Product, "ProductId", "ImageName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ImageId,ProductId,ImageName,ContentType,Image")] ProductImage productImage)
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.Product, "ProductId", "ImageName", productImage.ProductId);
            return View(productImage);
        }
        ...
        {
          return (_context.ProductImage?.Any(e => e.ImageId == id)).GetValueOrDefault();
        }
    }
}
